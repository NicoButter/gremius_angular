  ...
  private sedes: Sede[] = [
    {
      ...
      image: 'assets/images/sede_rio_gallegos_2.webp',
      ...
      images: ['assets/images/sede_rio_gallegos.webp', 'assets/images/sede_rio_gallegos_2.webp'],
      videos: ['https://www.youtube.com/embed/VIDEO_ID_1'],
    },
    {
      id: 'sede2',
      name: 'Sede El Calafate',
      image: 'assets/images/sede_el_calafate.webp',
      description: 'La sede de El Calafate está enfocada en actividades culturales y de inclusión.',
      address: 'Avda. Presidente Kirchner 134, El Calafate, Santa Cruz',
      ...
      images: ['assets/images/sede_el_calafate_1.webp', 'assets/images/sede_el_calafate_2.webp', 'assets/images/sede_el_calafate_2.webp'],
      videos: ['https://www.youtube.com/embed/X0PgSGNhctY'],
    },
    {
      id: 'sede3',
      name: 'Sede San Julián',
      image: 'assets/images/sede_san_julian.webp',
      description: 'Sede dedicada a programas de capacitación y eventos comunitarios.',
      address: '9 de Julio 1186, San Julián, Santa Cruz',
      ...
      images: ['assets/images/sede_san_julian_1.webp', 'assets/images/sede_san_julian_2.webp'],
      videos: ['https://www.youtube.com/embed/9Ayupbb4l4Y'],
    },
    {
      id: 'sede4',
      name: 'Sede Caleta Olivia',
      image: 'assets/images/sede_caleta_olivia.webp',
      ...
      images: ['assets/images/sede_caleta_olivia_1.webp', 'assets/images/sede_caleta_olivia_2.webp', 'assets/images/sede_caleta_olivia_3.webp'],
